...
export default function LoginPage() {
  ...
  const { user, signInWithGoogle, signInWithApple, signInAsGuest, loading } = useAuth();
          ...
          <div className="max-w-5xl mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={loading || signingIn}
                className="flex items-center gap-2 px-4 py-2 bg-iron-900 text-white border border-iron-700
                  rounded-lg font-medium text-sm hover:bg-iron-800 transition-all disabled:opacity-50"
              >
                {(loading || signingIn) ? <Loader2 className="w-4 h-4 animate-spin" /> : (
                  <>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  onClick={handleGoogleSignIn}
                  disabled={loading || signingIn}
                  className="flex items-center justify-center gap-2.5 px-6 py-3.5 bg-white text-iron-900
                    rounded-xl font-semibold hover:bg-iron-100 transition-all disabled:opacity-50 shadow-lg"
                >
                ...
                <button
                  onClick={handleAppleSignIn}
                  disabled={loading || signingIn}
                  className="flex items-center justify-center gap-2.5 px-6 py-3.5 bg-iron-900 text-white border border-iron-700
                    rounded-xl font-semibold hover:bg-iron-800 transition-all disabled:opacity-50 shadow-lg"
                >
                  {signingIn ? <Loader2 className="w-5 h-5 animate-spin" /> : (
                    <>
